// Create the function prefill that returns an array of 
// n elements that all have the same value v. See if you 
// can do this without using a loop.
...
function prefill(n, v) {
  ...
  if(isNaN(parseInt(n)) || n % 1 != 0) throw new TypeError(`${n} is invalid`);
  var answer = new Array(n).fill(v);
  return answer;
}
